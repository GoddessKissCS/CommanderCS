...
namespace CommanderCS.Library.Battle.Internal
{
    public class _UnitUpdater : FrameAccessor
    {
        ...
        public void UpdateUnitStatus()
        {
            ...
            {
                unit._maxHealth = (int)((unitDr.maxHealth + unit._addHp) * (100L + unit.maxHealthBonus) / 100);
            }
                ...
                if (!unit.isDead)
                {
                    if (unit._hasEventHpSkill)
                    {
                        ...
                        if (num2 >= 0 && !unit.skills[num2].isIgnoreDeathType)
                        {
                            ...
                            int num3 = (int)(unit._health * 100L / unit._maxHealth);
            ...
            if (unit._health <= 0)
            {
                ...
                if (num6 >= 0 && unit.skills[num6].isIgnoreDeathType)
                {
                    ...
                    int num7 = (int)(unit._health * 100L / unit._maxHealth);
        ...
        public override void OnUnitAccessEnd()
        {
            ...
            for (int k = 0; k < _activatableSkills.Count; k++)
            {
                ...
                int num6 = (int)(skillDataRow.attackDamage * (long)skill.SkillLevelFormal.AttackDamage / 1000);
                ...
                skill._criticalDamage = (int)(skill.attackDamage * (long)(100 + num10 + criticalDamageBonus + criticalDamageBonus2) / 100);
                ...
                if (unit.isEnableEventSkill)
                {
                    ...
                    {
                        skill._attackDamage = (int)(skill._attackDamage * 110L / 100);
                        skill._criticalDamage = (int)(skill._criticalDamage * 110L / 100);
                    }
                    if (unit.eventSkillType != EventSkillType.OnCombo)
                    {
                ...
                {
                    int num11 = (int)(unit._maxHealth * (long)skill.SkillDataRow.consumeHpRate / 100);
        ...
        public override bool OnSkillAccessStart()
        {
            ...
            {
                Regulation.Regulation.ExtendList(ref _activatableSkills, 5);
            }

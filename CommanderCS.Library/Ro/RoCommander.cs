...
namespace CommanderCS.Library.Ro
{
    ...
    public class RoCommander
    {
        ...
        public Dictionary<int, int[]> GetClassUpMaterial()
        {
            ...
            CommanderClassDataRow commanderClassDataRow = RemoteObjectManager.instance.regulation.commanderClassDtbl.Find((list) => list.index == int.Parse(id) && list.cls == cls);
        ...
        public FavorDataRow GetFavorData(int step)
        {
            ...
            return list.Find((row) => row.step == step);
        }

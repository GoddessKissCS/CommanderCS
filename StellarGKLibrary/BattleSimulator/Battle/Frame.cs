...
namespace BattleSimulator.Battle
{
	...
	public class Frame
	{
			...
			if (eskillTargetType != ESkillTargetType.Own)
			{
				...
				case 6:
					...
					case ESkillTargetPattern.Front:
						array = _PriorityFrontTable036;
						break;
					case ESkillTargetPattern.Back:
						array = _PriorityBackTable036;
						break;
				...
				case 7:
					...
					{
					case ESkillTargetPattern.Normal:
						array = _PriorityTable147;
						break;
					case ESkillTargetPattern.Front:
						array = _PriorityFrontTable147;
						break;
					case ESkillTargetPattern.Back:
						array = _PriorityBackTable147;
						break;
					case ESkillTargetPattern.sequence:
						array = _PriorityFrontTable036;
						break;
				...
				case 8:
					...
					case ESkillTargetPattern.Normal:
						...
						break;
					case ESkillTargetPattern.Front:
						array = _PriorityFrontTable258;
						break;
					case ESkillTargetPattern.Back:
						array = _PriorityBackTable258;
						break;
					case ESkillTargetPattern.sequence:
						array = _PriorityFrontTable036;
						break;
		...
		private int[,] GetRandomPriorityTable()
		{
			...
			{
			case 0:
				return _PriorityTable036;
			case 1:
				return _PriorityTable258;
			case 2:
				return _PriorityTable147;
			case 3:
				return _PriorityFrontTable036;
			case 4:
				return _PriorityFrontTable258;
			case 5:
				return _PriorityFrontTable147;
			case 6:
				return _PriorityBackTable036;
			case 7:
				return _PriorityBackTable258;
			case 8:
				return _PriorityBackTable147;
			default:
				return _PriorityTable036;
			}
		}

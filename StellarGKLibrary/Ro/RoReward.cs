...
public class RoReward
{
	...
	[JsonProperty]
	public List<RoReward.Condition> conditionList { get; set; }
	...
	private void OnDeserialized(StreamingContext context)
	{
		...
		{
			conditionList = new List<RoReward.Condition>();
		}
	}
	...
	{
		return !IsExistCondition() || GetCurrentConditionCount() >= GetTargetConditionCount();
	}
	...
	public int GetCurrentConditionCount()
	{
		...
		{
			RoReward.Condition condition = conditionList[i];

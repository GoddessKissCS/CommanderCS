...
{
    [Packet(Id = CommanderCS.Library.Shared.Enum.Method.WorldDuelInformation)]
    public class WorldDuelInformation : BaseMethodHandler<WorldDuelInformationRequest>
    {
        ...
        {
            CommanderCS.Library.Shared.Protocols.WorldDuelInformation worldDuelInformation = new() { };
